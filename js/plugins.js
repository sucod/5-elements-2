...
{"name":"realanimations","status":true,"description":"讓「與人物相同」(事件/玩家) 顯示在圖片上方；圖片仍在地圖之上","parameters":{}},
{"name":"LowerPictures","status":true,"description":"讓「與人物相同」(事件/玩家) 顯示在圖片上方；圖片仍在地圖之上","parameters":{}},
{"name":"LowerPictures01","status":false,"description":"把「圖片 Pictures」顯示在事件(角色)之下、地圖之上","parameters":{}}
];
